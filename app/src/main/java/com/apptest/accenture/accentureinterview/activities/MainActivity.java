...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //CreateSQLite createSQLite = new CreateSQLite(MainActivity.this);
        //createSQLite.execute();
        ...
        for (int j = 0; j < tabsCount; j++) {
            ...
            for (int i = 0; i < tabChildsCount; i++) {
                ...
                if (tabViewChild instanceof TextView) {
                    ...
                    ((TextView) tabViewChild).setTypeface(Typeface.createFromAsset(getApplicationContext().getAssets(), "DINEngschriftStd.ttf"));
                }
            }
        }
    }
